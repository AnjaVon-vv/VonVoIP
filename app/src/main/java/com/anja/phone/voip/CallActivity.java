...
import com.anja.phone.voip.audio.AudioDecoder;
import com.anja.phone.voip.audio.AudioRecorder;
import com.anja.phone.voip.net.CallSignal;
import com.anja.phone.voip.net.NettyReceiverHandler;
import com.anja.phone.voip.provider.EncodeProvider;
import com.anja.phone.voip.utils.HttpUtil;
import com.anja.phone.voip.utils.MLOC;
import com.anja.phone.voip.utils.NetUtils;
...
public class CallActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.user_input_VoIP).setOnClickListener(this);
        ...
        mCountDownTimer = new CountDownTimer(10000, 1000) {
            ...
            public void onFinish() {
                if (!isAnswer){ //如果没有人应答，则挂断
                    ...
                    Toast.makeText(CallActivity.this,"打电话超时，请稍后再试！",Toast.LENGTH_SHORT).show();
                }
    ...
    public void onBackPressed(){
        new AlertDialog.Builder(CallActivity.this).setCancelable(true)
                .setTitle("是否退出?")
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.Create_button: //手动输入ip地址
                showUserInputIpView();
                break;
            case R.id.user_input_VoIP: //手动输入ip地址进行拨打操作
                //获取ip地址
